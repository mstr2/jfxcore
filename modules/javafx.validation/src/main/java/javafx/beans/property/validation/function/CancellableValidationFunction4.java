 ...
 */
@FunctionalInterface
public interface CancellableValidationFunction4<T, D1, D2, D3, D4, E> {

    /**
     * Applies this function to the given arguments.
     */
    ValidationResult<E> apply(T value, D1 dependency1, D2 dependency2, D3 dependency3, D4 dependency4, AtomicBoolean cancellationRequested);
