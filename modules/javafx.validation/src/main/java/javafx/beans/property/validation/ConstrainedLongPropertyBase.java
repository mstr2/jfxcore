...
import org.jfxcore.beans.property.validation.LongPropertyImpl;
...
public abstract class ConstrainedLongPropertyBase<E> extends ConstrainedLongProperty<E> {
    ...
    static {
        ValidationHelper.setAccessor(
            ConstrainedLongPropertyBase.class,
            property -> ((ConstrainedLongPropertyBase<?>)property).validationHelper);
    }
