...
public final class ConstrainedElement<T, D> implements ConstrainedValue<T, D> {
    ...
    private static final SerializedValidator<?, ?> VALID_RESULT = new SerializedValidator<>(null, null) {
    ...
    private static final SerializedValidator<?, ?> INVALID_RESULT = new SerializedValidator<>(null, null) {
    ...
    private static final SerializedValidator<?, ?> NO_RESULT = new SerializedValidator<>(null, null) {
     ...
     * <p>
     * A {@link Validator constraint validator} may generate a diagnostic as part of the returned
     * {@link ValidationResult}. Diagnostics are application-specified data objects that can be used to
     * provide information about the validated value. For example, if a value fails to validate, the
     * validator may want to provide an error message for the invalid value.
     * <p>
    ...
    private class ValidatorImpl extends SerializedValidator<T, D> {
        ...
        @SuppressWarnings("unchecked")
        public ValidatorImpl(int index, Constraint<? super T, D> constraint) {
