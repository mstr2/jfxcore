...
public class ObservableStringValueTest {

    @Test
    public void testObservableStringValue() {
        var wrapper = ObservableStringValue.observableStringValue(null);
        assertNull(wrapper.getValue());
        assertNull(wrapper.get());

        wrapper = ObservableStringValue.observableStringValue("foo");
