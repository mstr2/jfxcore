...
public class ObservableIntegerValueTest {

    @Test
    public void testObservableIntegerValue() {
        var wrapper = ObservableIntegerValue.observableIntegerValue(null);
        assertNull(wrapper.getValue());
        assertEquals(0, wrapper.get());

        wrapper = ObservableIntegerValue.observableIntegerValue(1);
