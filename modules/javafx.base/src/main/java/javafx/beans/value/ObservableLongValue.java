...
public interface ObservableLongValue extends ObservableNumberValue {
    ...
    /**
     * Returns a new {@link ObservableLongValue} that wraps a constant long value.
     *
     * @param value the constant long value
     * @return the new {@link ObservableLongValue}
     *
     * @since JFXcore 18
     */
    static ObservableLongValue observableLongValue(Number value) {
